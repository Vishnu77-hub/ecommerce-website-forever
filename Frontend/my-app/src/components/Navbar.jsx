...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between py-5 font-medium">
            ...
            <Link to={'/'}><img  src={assets.logo} alt="logo" className='w-36'></img></Link>
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                   <Link to={'/login'}> <img src={assets.profile_icon} className='w-5 cursor-pointer' alt="" /></Link>
                    <div className='group-hover:block hidden absolute fropdown-menu right-0 pt-4'>
            ...
            <div className={`absolute top-0 right-0 botom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'} duration-300`}>
